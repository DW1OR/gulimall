...
public class GenUtils {
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("MongoChildrenEntity.java.vm")) {
            return packagePath + "domain" + File.separator + "inner" + File.separator + currentTableName+ File.separator + splitInnerName(className)+ "InnerEntity.java";
        }
        if (template.contains("Domain.java.vm") || template.contains("MongoEntity.java.vm")) {
